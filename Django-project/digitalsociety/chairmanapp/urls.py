...
urlpatterns = [
    ...
    path('view-complaint-chairman/',views.view_complaint_chairman, name='view-complaint-chairman'),
    path('view-complaint-chairman-details/<int:pk>',views.view_complaint_chairman_details, name='view-complaint-chairman-details'),
]
